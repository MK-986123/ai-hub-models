...
Use our lightweight command-line interface to inspect and download Swin-Tiny:

```bash
pip install qai_hub_models_cli # (the CLI is also available with the qai-hub-models package)

# Inspect the model and list the available download options
qai-hub-models info Swin-Tiny

# Print performance and accuracy metrics
qai-hub-models perf Swin-Tiny
qai-hub-models numerics Swin-Tiny

# Download a ready-to-deploy asset
qai-hub-models fetch Swin-Tiny --runtime tflite --precision float
```
...
```bash
qai-hub-models export swin_tiny --target-runtime tflite --precision float
```
