...
This repository contains scripts for optimized on-device export suitable to run on Qualcomm® devices. More details on model performance across various devices, can be found [here](https://aihub.qualcomm.com/models/ffnet_122ns_lowres).

Qualcomm AI Hub Models uses [Qualcomm AI Hub Workbench](https://workbench.aihub.qualcomm.com) to compile, profile, and evaluate this model. [Sign up](https://myaccount.qualcomm.com/signup) to run these models on a hosted Qualcomm® device.

## Quick Start

Use our lightweight command-line interface to inspect and download FFNet-122NS-LowRes:

```bash
pip install qai_hub_models_cli # (the CLI is also available with the qai-hub-models package)

# Inspect the model and list the available download options
qai-hub-models info FFNet-122NS-LowRes

# Print performance and accuracy metrics
qai-hub-models perf FFNet-122NS-LowRes
qai-hub-models numerics FFNet-122NS-LowRes

# Download a ready-to-deploy asset
qai-hub-models fetch FFNet-122NS-LowRes --runtime tflite --precision float
```
...
```bash
qai-hub-models export ffnet_122ns_lowres --target-runtime tflite --precision float
```
