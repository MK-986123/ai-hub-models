...
Use our lightweight command-line interface to inspect and download CavaFace:

```bash
pip install qai_hub_models_cli # (the CLI is also available with the qai-hub-models package)

# Inspect the model and list the available download options
qai-hub-models info CavaFace

# Print performance and accuracy metrics
qai-hub-models perf CavaFace
qai-hub-models numerics CavaFace

# Download a ready-to-deploy asset
qai-hub-models fetch CavaFace --runtime tflite --precision float
```
