...
```bash
qai-hub-models export qwen3_vl_8b_instruct --checkpoint DEFAULT_W4A16 --target-runtime geniex_qairt --device "Samsung Galaxy S25 (Family)"
```
...
```bash
python -m qai_hub_models.models.qwen3_vl_8b_instruct.quantize --precision w4a16 --output-dir ./quantized_checkpoint
qai-hub-models export qwen3_vl_8b_instruct --checkpoint ./quantized_checkpoint --target-runtime geniex_qairt --device "Samsung Galaxy S25 (Family)"
```
