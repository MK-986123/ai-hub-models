...
Use our lightweight command-line interface to inspect YOLO26-Detection:

```bash
pip install qai_hub_models_cli # (the CLI is also available with the qai-hub-models package)

# Inspect the model's metadata
qai-hub-models info YOLO26-Detection

# Print performance and accuracy metrics
qai-hub-models perf YOLO26-Detection
qai-hub-models numerics YOLO26-Detection
...
```bash
qai-hub-models export yolo26_det --target-runtime tflite --precision float
```
