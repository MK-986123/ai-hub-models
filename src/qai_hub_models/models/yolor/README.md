...
Use our lightweight command-line interface to inspect Yolo-R:

```bash
pip install qai_hub_models_cli # (the CLI is also available with the qai-hub-models package)

# Inspect the model's metadata
qai-hub-models info Yolo-R

# Print performance and accuracy metrics
qai-hub-models perf Yolo-R
qai-hub-models numerics Yolo-R
...
```bash
qai-hub-models export yolor --target-runtime onnx --precision float
```
