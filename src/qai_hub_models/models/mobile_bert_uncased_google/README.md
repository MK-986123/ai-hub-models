...
Use our lightweight command-line interface to inspect and download Mobile-Bert-Uncased-Google:

```bash
pip install qai_hub_models_cli # (the CLI is also available with the qai-hub-models package)

# Inspect the model and list the available download options
qai-hub-models info Mobile-Bert-Uncased-Google

# Print performance and accuracy metrics
qai-hub-models perf Mobile-Bert-Uncased-Google
qai-hub-models numerics Mobile-Bert-Uncased-Google

# Download a ready-to-deploy asset
qai-hub-models fetch Mobile-Bert-Uncased-Google --runtime tflite --precision float
```
...
```bash
qai-hub-models export mobile_bert_uncased_google --target-runtime tflite --precision float
```
