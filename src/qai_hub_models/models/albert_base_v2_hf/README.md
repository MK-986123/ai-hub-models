...
Use our lightweight command-line interface to inspect and download Albert-Base-V2-Hf:

```bash
pip install qai_hub_models_cli # (the CLI is also available with the qai-hub-models package)

# Inspect the model and list the available download options
qai-hub-models info Albert-Base-V2-Hf

# Print performance and accuracy metrics
qai-hub-models perf Albert-Base-V2-Hf
qai-hub-models numerics Albert-Base-V2-Hf

# Download a ready-to-deploy asset
qai-hub-models fetch Albert-Base-V2-Hf --runtime tflite --precision float
```
...
```bash
qai-hub-models export albert_base_v2_hf --target-runtime tflite --precision float
```
