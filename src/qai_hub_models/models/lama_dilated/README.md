...
Use our lightweight command-line interface to inspect and download LaMa-Dilated:

```bash
pip install qai_hub_models_cli # (the CLI is also available with the qai-hub-models package)

# Inspect the model and list the available download options
qai-hub-models info LaMa-Dilated

# Print performance and accuracy metrics
qai-hub-models perf LaMa-Dilated
qai-hub-models numerics LaMa-Dilated

# Download a ready-to-deploy asset
qai-hub-models fetch LaMa-Dilated --runtime tflite --precision float
```
...
```bash
qai-hub-models export lama_dilated --target-runtime tflite --precision float
```
