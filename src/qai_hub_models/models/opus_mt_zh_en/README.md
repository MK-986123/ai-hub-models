...
Use our lightweight command-line interface to inspect and download OpusMT-Zh-En:

```bash
pip install qai_hub_models_cli # (the CLI is also available with the qai-hub-models package)

# Inspect the model and list the available download options
qai-hub-models info OpusMT-Zh-En

# Print performance and accuracy metrics
qai-hub-models perf OpusMT-Zh-En
qai-hub-models numerics OpusMT-Zh-En

# Download a ready-to-deploy asset
qai-hub-models fetch OpusMT-Zh-En --runtime voice_ai --precision float
```
...
```bash
qai-hub-models export opus_mt_zh_en --target-runtime voice_ai --precision float --device "Samsung Galaxy S25 (Family)"
```
