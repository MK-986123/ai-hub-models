...
Use our lightweight command-line interface to inspect and download CVT:

```bash
pip install qai_hub_models_cli # (the CLI is also available with the qai-hub-models package)

# Inspect the model and list the available download options
qai-hub-models info CVT

# Print performance and accuracy metrics
qai-hub-models perf CVT
qai-hub-models numerics CVT

# Download a ready-to-deploy asset
qai-hub-models fetch CVT --runtime tflite --precision float
```
...
```bash
qai-hub-models export cvt --target-runtime tflite --precision float
```
