...
Use our lightweight command-line interface to inspect and download EfficientViT-l2-cls:

```bash
pip install qai_hub_models_cli # (the CLI is also available with the qai-hub-models package)

# Inspect the model and list the available download options
qai-hub-models info EfficientViT-l2-cls

# Print performance and accuracy metrics
qai-hub-models perf EfficientViT-l2-cls
qai-hub-models numerics EfficientViT-l2-cls

# Download a ready-to-deploy asset
qai-hub-models fetch EfficientViT-l2-cls --runtime tflite --precision float
```
...
```bash
qai-hub-models export efficientvit_l2_cls --target-runtime tflite --precision float
```
