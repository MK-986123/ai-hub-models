...
Use our lightweight command-line interface to inspect and download Qwen3-4B:

```bash
pip install qai_hub_models_cli # (the CLI is also available with the qai-hub-models package)

# Inspect the model and list the available download options
qai-hub-models info Qwen3-4B

# Print performance and accuracy metrics
qai-hub-models perf Qwen3-4B
qai-hub-models numerics Qwen3-4B

# Download a ready-to-deploy asset
qai-hub-models fetch Qwen3-4B --runtime geniex_qairt --precision w4a16
```
...
```bash
qai-hub-models export qwen3_4b --checkpoint DEFAULT_W4A16 --target-runtime geniex_qairt --device "Samsung Galaxy S25 (Family)"
```
...
```bash
python -m qai_hub_models.models.qwen3_4b.quantize --precision w4a16 --output-dir ./quantized_checkpoint
qai-hub-models export qwen3_4b --checkpoint ./quantized_checkpoint --target-runtime geniex_qairt --device "Samsung Galaxy S25 (Family)"
```
