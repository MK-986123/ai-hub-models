...
This repository contains scripts for optimized on-device export suitable to run on Qualcomm® devices. More details on model performance across various devices, can be found [here](https://aihub.qualcomm.com/models/depth_anything_v2).

Qualcomm AI Hub Models uses [Qualcomm AI Hub Workbench](https://workbench.aihub.qualcomm.com) to compile, profile, and evaluate this model. [Sign up](https://myaccount.qualcomm.com/signup) to run these models on a hosted Qualcomm® device.

## Quick Start

Use our lightweight command-line interface to inspect and download Depth-Anything-V2:
...
qai-hub-models perf Depth-Anything-V2
qai-hub-models numerics Depth-Anything-V2

# Download a ready-to-deploy asset
qai-hub-models fetch Depth-Anything-V2 --runtime tflite --precision float
```
...
```bash
qai-hub-models export depth_anything_v2 --target-runtime tflite --precision float
```
