...
Use our lightweight command-line interface to inspect and download StereoNet:

```bash
pip install qai_hub_models_cli # (the CLI is also available with the qai-hub-models package)

# Inspect the model and list the available download options
qai-hub-models info StereoNet

# Print performance and accuracy metrics
qai-hub-models perf StereoNet
qai-hub-models numerics StereoNet

# Download a ready-to-deploy asset
qai-hub-models fetch StereoNet --runtime tflite --precision float
```
...
```bash
qai-hub-models export stereonet --target-runtime tflite --precision float
```
