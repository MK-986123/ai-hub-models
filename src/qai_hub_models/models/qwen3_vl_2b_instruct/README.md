# [Qwen3-VL-2B-Instruct: Multimodal 2B vision-language model capable of understanding text and images](https://aihub.qualcomm.com/models/qwen3_vl_2b_instruct)
...
This repository contains scripts for optimized on-device export suitable to run on Qualcomm® devices. More details on model performance across various devices, can be found [here](https://aihub.qualcomm.com/models/qwen3_vl_2b_instruct).
...
qai-hub-models fetch Qwen3-VL-2B-Instruct --runtime geniex_llamacpp --precision q4_0
```
