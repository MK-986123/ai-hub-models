...
Use our lightweight command-line interface to inspect and download Swin-Small:

```bash
pip install qai_hub_models_cli # (the CLI is also available with the qai-hub-models package)

# Inspect the model and list the available download options
qai-hub-models info Swin-Small

# Print performance and accuracy metrics
qai-hub-models perf Swin-Small
qai-hub-models numerics Swin-Small

# Download a ready-to-deploy asset
qai-hub-models fetch Swin-Small --runtime tflite --precision float
```
...
```bash
qai-hub-models export swin_small --target-runtime tflite --precision float
```
