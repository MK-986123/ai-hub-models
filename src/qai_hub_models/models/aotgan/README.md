...
Use our lightweight command-line interface to inspect and download AOT-GAN:

```bash
pip install qai_hub_models_cli # (the CLI is also available with the qai-hub-models package)

# Inspect the model and list the available download options
qai-hub-models info AOT-GAN

# Print performance and accuracy metrics
qai-hub-models perf AOT-GAN
qai-hub-models numerics AOT-GAN

# Download a ready-to-deploy asset
qai-hub-models fetch AOT-GAN --runtime tflite --precision float
```
...
```bash
qai-hub-models export aotgan --target-runtime tflite --precision float
```
