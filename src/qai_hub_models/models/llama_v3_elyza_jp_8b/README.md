...
Use our lightweight command-line interface to inspect Llama-v3-ELYZA-JP-8B:

```bash
pip install qai_hub_models_cli # (the CLI is also available with the qai-hub-models package)

# Inspect the model's metadata
qai-hub-models info Llama-v3-ELYZA-JP-8B

# Print performance and accuracy metrics
qai-hub-models perf Llama-v3-ELYZA-JP-8B
qai-hub-models numerics Llama-v3-ELYZA-JP-8B
...
```bash
qai-hub-models export llama_v3_elyza_jp_8b --checkpoint DEFAULT_W4A16 --target-runtime geniex_qairt --device "Samsung Galaxy S25 (Family)"
```
...
```bash
python -m qai_hub_models.models.llama_v3_elyza_jp_8b.quantize --precision w4a16 --output-dir ./quantized_checkpoint
qai-hub-models export llama_v3_elyza_jp_8b --checkpoint ./quantized_checkpoint --target-runtime geniex_qairt --device "Samsung Galaxy S25 (Family)"
```
