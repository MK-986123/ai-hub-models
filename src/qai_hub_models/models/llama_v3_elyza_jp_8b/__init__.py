...
from .model import Llama3_Elyza_JP_8B as FP_Model
from .model import Llama3_Elyza_JP_8B_AIMETOnnx as Model
from .model import Llama3_Elyza_JP_8B_QNN as QNN_Model
