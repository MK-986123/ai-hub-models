...
Use our lightweight command-line interface to inspect and download ResNet34-SSD:

```bash
pip install qai_hub_models_cli # (the CLI is also available with the qai-hub-models package)

# Inspect the model and list the available download options
qai-hub-models info ResNet34-SSD

# Print performance and accuracy metrics
qai-hub-models perf ResNet34-SSD
qai-hub-models numerics ResNet34-SSD

# Download a ready-to-deploy asset
qai-hub-models fetch ResNet34-SSD --runtime tflite --precision float
```
...
```bash
qai-hub-models export resnet34_ssd1200 --target-runtime tflite --precision float
```
