...
This repository contains scripts for optimized on-device export suitable to run on Qualcomm® devices. More details on model performance across various devices, can be found [here](https://aihub.qualcomm.com/models/mobilenet_v3_large).

Qualcomm AI Hub Models uses [Qualcomm AI Hub Workbench](https://workbench.aihub.qualcomm.com) to compile, profile, and evaluate this model. [Sign up](https://myaccount.qualcomm.com/signup) to run these models on a hosted Qualcomm® device.

## Quick Start

Use our lightweight command-line interface to inspect and download MobileNet-v3-Large:

```bash
pip install qai_hub_models_cli # (the CLI is also available with the qai-hub-models package)

# Inspect the model and list the available download options
qai-hub-models info MobileNet-v3-Large

# Print performance and accuracy metrics
qai-hub-models perf MobileNet-v3-Large
qai-hub-models numerics MobileNet-v3-Large

# Download a ready-to-deploy asset
qai-hub-models fetch MobileNet-v3-Large --runtime tflite --precision float
```
...
```bash
qai-hub-models export mobilenet_v3_large --target-runtime tflite --precision float
```
