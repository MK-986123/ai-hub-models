...
Use our lightweight command-line interface to inspect and download PPE-Detection:

```bash
pip install qai_hub_models_cli # (the CLI is also available with the qai-hub-models package)

# Inspect the model and list the available download options
qai-hub-models info PPE-Detection

# Print performance and accuracy metrics
qai-hub-models perf PPE-Detection
qai-hub-models numerics PPE-Detection

# Download a ready-to-deploy asset
qai-hub-models fetch PPE-Detection --runtime tflite --precision float
```
...
```bash
qai-hub-models export gear_guard_net --target-runtime tflite --precision float
```
