...
Use our lightweight command-line interface to inspect Llama3-TAIDE-LX-8B-Chat-Alpha1:

```bash
pip install qai_hub_models_cli # (the CLI is also available with the qai-hub-models package)

# Inspect the model's metadata
qai-hub-models info Llama3-TAIDE-LX-8B-Chat-Alpha1

# Print performance and accuracy metrics
qai-hub-models perf Llama3-TAIDE-LX-8B-Chat-Alpha1
qai-hub-models numerics Llama3-TAIDE-LX-8B-Chat-Alpha1
...
## Deploying Llama3-TAIDE-LX-8B-Chat-Alpha1 on-device
...
```bash
qai-hub-models export llama_v3_taide_8b_chat --checkpoint DEFAULT_W4A16 --target-runtime geniex_qairt --device "Samsung Galaxy S25 (Family)"
```
...
```bash
python -m qai_hub_models.models.llama_v3_taide_8b_chat.quantize --precision w4a16 --output-dir ./quantized_checkpoint
qai-hub-models export llama_v3_taide_8b_chat --checkpoint ./quantized_checkpoint --target-runtime geniex_qairt --device "Samsung Galaxy S25 (Family)"
```
