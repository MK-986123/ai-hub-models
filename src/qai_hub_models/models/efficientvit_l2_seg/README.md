...
This is based on the implementation of EfficientViT-l2-seg found [here](https://github.com/CVHub520/efficientvit).
This repository contains scripts for optimized on-device export suitable to run on Qualcomm® devices. More details on model performance across various devices, can be found [here](https://aihub.qualcomm.com/models/efficientvit_l2_seg).

Qualcomm AI Hub Models uses [Qualcomm AI Hub Workbench](https://workbench.aihub.qualcomm.com) to compile, profile, and evaluate this model. [Sign up](https://myaccount.qualcomm.com/signup) to run these models on a hosted Qualcomm® device.

## Quick Start

Use our lightweight command-line interface to inspect and download EfficientViT-l2-seg:

```bash
pip install qai_hub_models_cli # (the CLI is also available with the qai-hub-models package)

# Inspect the model and list the available download options
qai-hub-models info EfficientViT-l2-seg

# Print performance and accuracy metrics
qai-hub-models perf EfficientViT-l2-seg
qai-hub-models numerics EfficientViT-l2-seg

# Download a ready-to-deploy asset
qai-hub-models fetch EfficientViT-l2-seg --runtime qnn_context_binary --precision float
```
...
```bash
qai-hub-models export efficientvit_l2_seg --target-runtime qnn_context_binary --precision float
```
