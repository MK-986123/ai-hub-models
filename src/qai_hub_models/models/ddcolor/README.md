...
Use our lightweight command-line interface to inspect and download DDColor:

```bash
pip install qai_hub_models_cli # (the CLI is also available with the qai-hub-models package)

# Inspect the model and list the available download options
qai-hub-models info DDColor

# Print performance and accuracy metrics
qai-hub-models perf DDColor
qai-hub-models numerics DDColor

# Download a ready-to-deploy asset
qai-hub-models fetch DDColor --runtime tflite --precision float
```
...
```bash
qai-hub-models export ddcolor --target-runtime tflite --precision float
```
