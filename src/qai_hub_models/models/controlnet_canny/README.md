...
Use our lightweight command-line interface to inspect and download ControlNet-Canny:

```bash
pip install qai_hub_models_cli # (the CLI is also available with the qai-hub-models package)

# Inspect the model and list the available download options
qai-hub-models info ControlNet-Canny

# Print performance and accuracy metrics
qai-hub-models perf ControlNet-Canny
qai-hub-models numerics ControlNet-Canny

# Download a ready-to-deploy asset
qai-hub-models fetch ControlNet-Canny --runtime qnn_context_binary --precision w8a16
```
...
```bash
qai-hub-models export controlnet_canny --target-runtime qnn_context_binary --precision w8a16 --device "Samsung Galaxy S25 (Family)"
```
