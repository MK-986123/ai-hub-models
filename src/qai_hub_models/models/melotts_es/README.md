...
Use our lightweight command-line interface to inspect and download MeloTTS-ES:

```bash
pip install qai_hub_models_cli # (the CLI is also available with the qai-hub-models package)

# Inspect the model and list the available download options
qai-hub-models info MeloTTS-ES

# Print performance and accuracy metrics
qai-hub-models perf MeloTTS-ES
qai-hub-models numerics MeloTTS-ES

# Download a ready-to-deploy asset
qai-hub-models fetch MeloTTS-ES --runtime voice_ai --precision mixed_with_float
```
See the [CLI README](../../../../cli/README.md)
for the full list of commands and filters.

## Deploying MeloTTS-ES on-device
...
```bash
qai-hub-models export melotts_es --target-runtime voice_ai --precision mixed_with_float --device "Samsung Galaxy S25 (Family)"
```
