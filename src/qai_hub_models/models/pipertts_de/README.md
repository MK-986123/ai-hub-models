# [PiperTTS-DE: High-quality text-to-speech for German](https://aihub.qualcomm.com/models/pipertts_de)
...
Use our lightweight command-line interface to inspect and download PiperTTS-DE:

```bash
pip install qai_hub_models_cli # (the CLI is also available with the qai-hub-models package)

# Inspect the model and list the available download options
qai-hub-models info PiperTTS-DE

# Print performance and accuracy metrics
qai-hub-models perf PiperTTS-DE
qai-hub-models numerics PiperTTS-DE

# Download a ready-to-deploy asset
qai-hub-models fetch PiperTTS-DE --runtime voice_ai --precision float
```
...
```bash
qai-hub-models export pipertts_de --target-runtime voice_ai --precision float --device "Samsung Galaxy S25 (Family)"
```
