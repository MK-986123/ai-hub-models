...
Use our lightweight command-line interface to inspect and download DETR-ResNet101-DC5:

```bash
pip install qai_hub_models_cli # (the CLI is also available with the qai-hub-models package)

# Inspect the model and list the available download options
qai-hub-models info DETR-ResNet101-DC5

# Print performance and accuracy metrics
qai-hub-models perf DETR-ResNet101-DC5
qai-hub-models numerics DETR-ResNet101-DC5

# Download a ready-to-deploy asset
qai-hub-models fetch DETR-ResNet101-DC5 --runtime tflite --precision float
```
...
```bash
qai-hub-models export detr_resnet101_dc5 --target-runtime tflite --precision float
```
