# [EfficientNet-V2-s: Imagenet classifier and general purpose backbone](https://aihub.qualcomm.com/models/efficientnet_v2_s)
...
This repository contains scripts for optimized on-device export suitable to run on Qualcomm® devices. More details on model performance across various devices, can be found [here](https://aihub.qualcomm.com/models/efficientnet_v2_s).

Qualcomm AI Hub Models uses [Qualcomm AI Hub Workbench](https://workbench.aihub.qualcomm.com) to compile, profile, and evaluate this model. [Sign up](https://myaccount.qualcomm.com/signup) to run these models on a hosted Qualcomm® device.

## Quick Start

Use our lightweight command-line interface to inspect and download EfficientNet-V2-s:

```bash
pip install qai_hub_models_cli # (the CLI is also available with the qai-hub-models package)

# Inspect the model and list the available download options
qai-hub-models info EfficientNet-V2-s

# Print performance and accuracy metrics
qai-hub-models perf EfficientNet-V2-s
qai-hub-models numerics EfficientNet-V2-s

# Download a ready-to-deploy asset
qai-hub-models fetch EfficientNet-V2-s --runtime tflite --precision float
```
...
```bash
python -m qai_hub_models.models.efficientnet_v2_s.demo { --quantize w8a16 }
```
...
```bash
qai-hub-models export efficientnet_v2_s --target-runtime tflite --precision float
```
