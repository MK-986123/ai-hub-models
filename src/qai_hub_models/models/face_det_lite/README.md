...
Use our lightweight command-line interface to inspect and download Lightweight-Face-Detection:

```bash
pip install qai_hub_models_cli # (the CLI is also available with the qai-hub-models package)

# Inspect the model and list the available download options
qai-hub-models info Lightweight-Face-Detection

# Print performance and accuracy metrics
qai-hub-models perf Lightweight-Face-Detection
qai-hub-models numerics Lightweight-Face-Detection

# Download a ready-to-deploy asset
qai-hub-models fetch Lightweight-Face-Detection --runtime tflite --precision float
```
...
```bash
qai-hub-models export face_det_lite --target-runtime tflite --precision float
```
