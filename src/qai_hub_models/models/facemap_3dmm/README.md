...
Use our lightweight command-line interface to inspect and download Facial-Landmark-Detection:

```bash
pip install qai_hub_models_cli # (the CLI is also available with the qai-hub-models package)

# Inspect the model and list the available download options
qai-hub-models info Facial-Landmark-Detection

# Print performance and accuracy metrics
qai-hub-models perf Facial-Landmark-Detection
qai-hub-models numerics Facial-Landmark-Detection

# Download a ready-to-deploy asset
qai-hub-models fetch Facial-Landmark-Detection --runtime tflite --precision float
```
...
```bash
qai-hub-models export facemap_3dmm --target-runtime tflite --precision float
```
