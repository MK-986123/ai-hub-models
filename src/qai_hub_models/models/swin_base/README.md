...
Use our lightweight command-line interface to inspect and download Swin-Base:

```bash
pip install qai_hub_models_cli # (the CLI is also available with the qai-hub-models package)

# Inspect the model and list the available download options
qai-hub-models info Swin-Base

# Print performance and accuracy metrics
qai-hub-models perf Swin-Base
qai-hub-models numerics Swin-Base

# Download a ready-to-deploy asset
qai-hub-models fetch Swin-Base --runtime tflite --precision float
```
...
```bash
qai-hub-models export swin_base --target-runtime tflite --precision float
```
