...
Use our lightweight command-line interface to inspect YOLO26-Segmentation:

```bash
pip install qai_hub_models_cli # (the CLI is also available with the qai-hub-models package)

# Inspect the model's metadata
qai-hub-models info YOLO26-Segmentation

# Print performance and accuracy metrics
qai-hub-models perf YOLO26-Segmentation
qai-hub-models numerics YOLO26-Segmentation
...
```bash
qai-hub-models export yolo26_seg --target-runtime tflite --precision float
```
