...
Use our lightweight command-line interface to inspect and download Facial-Attribute-Detection:

```bash
pip install qai_hub_models_cli # (the CLI is also available with the qai-hub-models package)

# Inspect the model and list the available download options
qai-hub-models info Facial-Attribute-Detection

# Print performance and accuracy metrics
qai-hub-models perf Facial-Attribute-Detection
qai-hub-models numerics Facial-Attribute-Detection

# Download a ready-to-deploy asset
qai-hub-models fetch Facial-Attribute-Detection --runtime tflite --precision float
```
...
```bash
qai-hub-models export face_attrib_net --target-runtime tflite --precision float
```
