...
Use our lightweight command-line interface to inspect and download MediaPipe-Face-Detection:

```bash
pip install qai_hub_models_cli # (the CLI is also available with the qai-hub-models package)

# Inspect the model and list the available download options
qai-hub-models info MediaPipe-Face-Detection

# Print performance and accuracy metrics
qai-hub-models perf MediaPipe-Face-Detection
qai-hub-models numerics MediaPipe-Face-Detection

# Download a ready-to-deploy asset
qai-hub-models fetch MediaPipe-Face-Detection --runtime tflite --precision w8a8
```
...
```bash
qai-hub-models export mediapipe_face --target-runtime tflite --precision w8a8
```
