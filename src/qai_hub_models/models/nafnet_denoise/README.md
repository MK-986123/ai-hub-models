# [NAFNet-DeNoise: Denoise images in real time](https://aihub.qualcomm.com/models/nafnet_denoise)
...
This repository contains scripts for optimized on-device export suitable to run on Qualcomm® devices. More details on model performance across various devices, can be found [here](https://aihub.qualcomm.com/models/nafnet_denoise).

Qualcomm AI Hub Models uses [Qualcomm AI Hub Workbench](https://workbench.aihub.qualcomm.com) to compile, profile, and evaluate this model. [Sign up](https://myaccount.qualcomm.com/signup) to run these models on a hosted Qualcomm® device.

## Quick Start

Use our lightweight command-line interface to inspect and download NAFNet-DeNoise:

```bash
pip install qai_hub_models_cli # (the CLI is also available with the qai-hub-models package)

# Inspect the model and list the available download options
qai-hub-models info NAFNet-DeNoise

# Print performance and accuracy metrics
qai-hub-models perf NAFNet-DeNoise
...
pip install "qai-hub-models[nafnet-denoise]"
```
...
```bash
python -m qai_hub_models.models.nafnet_denoise.demo { --quantize w8a16 }
```
...
```bash
qai-hub-models export nafnet_denoise --target-runtime tflite --precision float
```
