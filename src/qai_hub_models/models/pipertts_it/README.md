...
```bash
python -m qai_hub_models.models.pipertts_it.demo { --quantize mixed_with_float }
```
...
```bash
python -m qai_hub_models.models.pipertts_it.export --device "Samsung Galaxy S25 (Family)" { --quantize mixed_with_float }
```
