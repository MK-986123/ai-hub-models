...
# Model architecture constants (from Llama 3.1 8B)
NUM_LAYERS = 32
NUM_SPLITS = 5
...
# Name used for split ONNX file basenames (e.g. Llama3_1_8B_1_of_5.onnx)
SPLIT_MODEL_NAME = "Llama3_1_8B"


class Llama3_1_8B_PreSplit(LlamaPreSplitBase):
    """FP PreSplit for Llama 3.1 8B."""
...
class Llama3_1_8B_QuantizablePreSplit(
    LlamaQuantizablePreSplitBase[Llama3_1_8B_PreSplit]
):
    """Quantizable PreSplit for Llama 3.1 8B."""

    FPModel = Llama3_1_8B_PreSplit
    GeneratorClass = HubCompatibleGenerator
...
class Llama3_1_8B_PartBase(LlamaPartBase):
    """Unified Part base for Llama 3.1 8B."""
    ...
    quant_presplit_cls = Llama3_1_8B_QuantizablePreSplit
    default_precision = DEFAULT_PRECISION


class Llama3_1_8B_Part1_Of_5(Llama3_1_8B_PartBase):
    """Part 1: Embedding."""

    part_id = 1


class Llama3_1_8B_Part2_Of_5(Llama3_1_8B_PartBase):
    """Part 2."""

    part_id = 2


class Llama3_1_8B_Part3_Of_5(Llama3_1_8B_PartBase):
    """Part 3."""

    part_id = 3


class Llama3_1_8B_Part4_Of_5(Llama3_1_8B_PartBase):
    """Part 4."""

    part_id = 4


class Llama3_1_8B_Part5_Of_5(Llama3_1_8B_PartBase):
...
_SPLIT_PART_CLASSES: list[type] = [
    Llama3_1_8B_Part1_Of_5,
    Llama3_1_8B_Part2_Of_5,
    Llama3_1_8B_Part3_Of_5,
    Llama3_1_8B_Part4_Of_5,
    Llama3_1_8B_Part5_Of_5,
]


class QuantizedSplitModelWrapper(  # type: ignore[misc]
    SplitForwardMixin, Llama3_1_8B_QuantizablePreSplit
):
...
class FPSplitModelWrapper(SplitForwardMixin, Llama3_1_8B_PreSplit):
...
class Llama3_1_8B_Collection(LlamaPreSplitCollectionBase):
    """Unified Collection with 5 Parts for Llama 3.1 8B."""

    hf_repo_name = HF_REPO_NAME
    fp_presplit_cls = Llama3_1_8B_PreSplit
    part_base_cls = Llama3_1_8B_PartBase
    parts = {
        "part1_of_5": Llama3_1_8B_Part1_Of_5,
        "part2_of_5": Llama3_1_8B_Part2_Of_5,
        "part3_of_5": Llama3_1_8B_Part3_Of_5,
        "part4_of_5": Llama3_1_8B_Part4_Of_5,
        "part5_of_5": Llama3_1_8B_Part5_Of_5,
    }
