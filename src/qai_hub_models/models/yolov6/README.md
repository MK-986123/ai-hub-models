...
This repository contains scripts for optimized on-device export suitable to run on Qualcomm® devices. More details on model performance across various devices, can be found [here](https://aihub.qualcomm.com/models/yolov6).

Qualcomm AI Hub Models uses [Qualcomm AI Hub Workbench](https://workbench.aihub.qualcomm.com) to compile, profile, and evaluate this model. [Sign up](https://myaccount.qualcomm.com/signup) to run these models on a hosted Qualcomm® device.

## Quick Start

Use our lightweight command-line interface to inspect Yolo-v6:

```bash
pip install qai_hub_models_cli # (the CLI is also available with the qai-hub-models package)

# Inspect the model's metadata
qai-hub-models info Yolo-v6

# Print performance and accuracy metrics
qai-hub-models perf Yolo-v6
qai-hub-models numerics Yolo-v6
...
```bash
python -m qai_hub_models.models.yolov6.demo { --quantize w8a16, w8a8 }
```
...
```bash
qai-hub-models export yolov6 --target-runtime tflite --precision float
```
