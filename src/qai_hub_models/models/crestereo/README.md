...
Use our lightweight command-line interface to inspect and download CREStereo:

```bash
pip install qai_hub_models_cli # (the CLI is also available with the qai-hub-models package)

# Inspect the model and list the available download options
qai-hub-models info CREStereo

# Print performance and accuracy metrics
qai-hub-models perf CREStereo
qai-hub-models numerics CREStereo

# Download a ready-to-deploy asset
qai-hub-models fetch CREStereo --runtime tflite --precision float
```
...
```bash
qai-hub-models export crestereo --target-runtime tflite --precision float
```
