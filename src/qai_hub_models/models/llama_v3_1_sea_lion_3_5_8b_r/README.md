...
Use our lightweight command-line interface to inspect Llama-SEA-LION-v3.5-8B-R:

```bash
pip install qai_hub_models_cli # (the CLI is also available with the qai-hub-models package)

# Inspect the model's metadata
qai-hub-models info Llama-SEA-LION-v3.5-8B-R

# Print performance and accuracy metrics
qai-hub-models perf Llama-SEA-LION-v3.5-8B-R
qai-hub-models numerics Llama-SEA-LION-v3.5-8B-R
...
```bash
qai-hub-models export llama_v3_1_sea_lion_3_5_8b_r --checkpoint DEFAULT_W4A16 --target-runtime geniex_qairt --device "Samsung Galaxy S25 (Family)"
```
...
```bash
python -m qai_hub_models.models.llama_v3_1_sea_lion_3_5_8b_r.quantize --precision w4a16 --output-dir ./quantized_checkpoint
qai-hub-models export llama_v3_1_sea_lion_3_5_8b_r --checkpoint ./quantized_checkpoint --target-runtime geniex_qairt --device "Samsung Galaxy S25 (Family)"
```
