...
Use our lightweight command-line interface to inspect and download Stable-Diffusion-v1.5:

```bash
pip install qai_hub_models_cli # (the CLI is also available with the qai-hub-models package)

# Inspect the model and list the available download options
qai-hub-models info Stable-Diffusion-v1.5

# Print performance and accuracy metrics
qai-hub-models perf Stable-Diffusion-v1.5
qai-hub-models numerics Stable-Diffusion-v1.5

# Download a ready-to-deploy asset
qai-hub-models fetch Stable-Diffusion-v1.5 --runtime qnn_context_binary --precision w8a16
```
...
```bash
qai-hub-models export stable_diffusion_v1_5 --target-runtime qnn_context_binary --precision w8a16 --device "Samsung Galaxy S25 (Family)"
```
