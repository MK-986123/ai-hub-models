...
Use our lightweight command-line interface to inspect and download CenterNet-3D:

```bash
pip install qai_hub_models_cli # (the CLI is also available with the qai-hub-models package)

# Inspect the model and list the available download options
qai-hub-models info CenterNet-3D

# Print performance and accuracy metrics
qai-hub-models perf CenterNet-3D
...
```bash
qai-hub-models export centernet_3d --target-runtime qnn_context_binary --precision w8a16 --device "Samsung Galaxy S25 (Family)"
```
