...
Use our lightweight command-line interface to inspect and download Detectron2-Detection:

```bash
pip install qai_hub_models_cli # (the CLI is also available with the qai-hub-models package)

# Inspect the model and list the available download options
qai-hub-models info Detectron2-Detection

# Print performance and accuracy metrics
qai-hub-models perf Detectron2-Detection
...
```bash
python -m qai_hub_models.models.detectron2_detection.demo { --quantize w8a16, w8a8 }
```
