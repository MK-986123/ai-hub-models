...
This repository contains scripts for optimized on-device export suitable to run on Qualcomm® devices. More details on model performance across various devices, can be found [here](https://aihub.qualcomm.com/models/yolov11_seg).

Qualcomm AI Hub Models uses [Qualcomm AI Hub Workbench](https://workbench.aihub.qualcomm.com) to compile, profile, and evaluate this model. [Sign up](https://myaccount.qualcomm.com/signup) to run these models on a hosted Qualcomm® device.

## Quick Start

Use our lightweight command-line interface to inspect YOLOv11-Segmentation:

```bash
pip install qai_hub_models_cli # (the CLI is also available with the qai-hub-models package)

# Inspect the model's metadata
qai-hub-models info YOLOv11-Segmentation

# Print performance and accuracy metrics
qai-hub-models perf YOLOv11-Segmentation
qai-hub-models numerics YOLOv11-Segmentation
...
```bash
qai-hub-models export yolov11_seg --target-runtime tflite --precision float
```
