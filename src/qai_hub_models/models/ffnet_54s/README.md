...
This is based on the implementation of FFNet-54S found [here](https://github.com/Qualcomm-AI-research/FFNet).
This repository contains scripts for optimized on-device export suitable to run on Qualcomm® devices. More details on model performance across various devices, can be found [here](https://aihub.qualcomm.com/models/ffnet_54s).

Qualcomm AI Hub Models uses [Qualcomm AI Hub Workbench](https://workbench.aihub.qualcomm.com) to compile, profile, and evaluate this model. [Sign up](https://myaccount.qualcomm.com/signup) to run these models on a hosted Qualcomm® device.

## Quick Start

Use our lightweight command-line interface to inspect and download FFNet-54S:

```bash
pip install qai_hub_models_cli # (the CLI is also available with the qai-hub-models package)

# Inspect the model and list the available download options
qai-hub-models info FFNet-54S

# Print performance and accuracy metrics
qai-hub-models perf FFNet-54S
qai-hub-models numerics FFNet-54S

# Download a ready-to-deploy asset
qai-hub-models fetch FFNet-54S --runtime tflite --precision float
```
...
```bash
qai-hub-models export ffnet_54s --target-runtime tflite --precision float
```
