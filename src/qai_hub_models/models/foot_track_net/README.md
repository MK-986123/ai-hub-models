...
Use our lightweight command-line interface to inspect and download Person-Foot-Detection:

```bash
pip install qai_hub_models_cli # (the CLI is also available with the qai-hub-models package)

# Inspect the model and list the available download options
qai-hub-models info Person-Foot-Detection

# Print performance and accuracy metrics
qai-hub-models perf Person-Foot-Detection
qai-hub-models numerics Person-Foot-Detection

# Download a ready-to-deploy asset
qai-hub-models fetch Person-Foot-Detection --runtime tflite --precision float
```
...
```bash
qai-hub-models export foot_track_net --target-runtime tflite --precision float
```
