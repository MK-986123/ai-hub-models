...
This repository contains scripts for optimized on-device export suitable to run on Qualcomm® devices. More details on model performance across various devices, can be found [here](https://aihub.qualcomm.com/models/trocr).

Qualcomm AI Hub Models uses [Qualcomm AI Hub Workbench](https://workbench.aihub.qualcomm.com) to compile, profile, and evaluate this model. [Sign up](https://myaccount.qualcomm.com/signup) to run these models on a hosted Qualcomm® device.

## Quick Start

Use our lightweight command-line interface to inspect and download TrOCR:
...
qai-hub-models perf TrOCR
qai-hub-models numerics TrOCR

# Download a ready-to-deploy asset
qai-hub-models fetch TrOCR --runtime tflite --precision float
```
...
```bash
qai-hub-models export trocr --target-runtime tflite --precision float
```
