...
Use our lightweight command-line interface to inspect and download BEVDet:

```bash
pip install qai_hub_models_cli # (the CLI is also available with the qai-hub-models package)

# Inspect the model and list the available download options
qai-hub-models info BEVDet

# Print performance and accuracy metrics
qai-hub-models perf BEVDet
qai-hub-models numerics BEVDet

# Download a ready-to-deploy asset
qai-hub-models fetch BEVDet --runtime tflite --precision float
```
...
```bash
qai-hub-models export bevdet --target-runtime tflite --precision float
```
